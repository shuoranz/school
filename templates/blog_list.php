            ...
            <aside class="col-md-4">
                <div class=" box_style_1">
                    ...
                    <div class="widget">
                        <h4>Categories</h4>
                        <ul class="categories">
                            <li><a href='/blog/?p=1' <?php if(!isset($_GET['c'])): ?> class="active" <?php endif; ?>>All
                                    blogs</a></li>
                    ...
                    <div class="post">
                        ...
                        <div class="right">
                            <div class="blog-title-container">
                                <a class="blog-title-link" href="/blog/thread/?id=<?php echo $blog['id']; ?>"
                                    title="single_post.html">
                            ...
                            <div class="post_info clearfix">
                                <div class="post-left">
                                    <ul>
                                        ...
                                        <li><i class="icon-flag-filled"></i> <a
                                                href='/blog/?c=<?php echo $blog['category_id'] ?>&p=1'><?php echo $blog['name'] ?></a>
                                        </li>
                                    </ul>
                                </div>
