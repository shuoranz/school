    ...
    <div class="container">
            ...
            <aside class="col-lg-3 col-md-4 col-sm-4">
                <div class="box_style_1">
                    ...
                    <ul class="submenu-col">
                        ...
                        <li><a href="/course/?category=<?php echo $courseCategory["id"]; ?>"
                    ...
                    <table class="table table-responsive table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><a class="course_list_a"
                                        href="/course/video?vid=<?php echo $video["id"]; ?>"><?php echo $video["username"]; ?></a>
                                </td>
                            </tr>
                            <?php endforeach; ?>
                        </tbody>
        ...
        <div class="row">
            <div class="col-md-12 text-center">
                <ul class="pagination">
                    <li><a <?php if($_GET['p'] > 1): ?>href="/course/search_video<?php echo copyAndSetPageURI($_GET, $_GET['p'] - 1) ?>"
                            <?php endif; ?> <?php if($_GET['p'] == 1): ?> style="background-color: #eee"
                            <?php endif; ?>>Prev</a>
                    </li>
                    <?php foreach($pages as $page): ?>
                    <li <?php if($page==$_GET['p']): ?>class="active" <?php endif; ?>>
                        <a
                            href="/course/search_video<?php echo copyAndSetPageURI($_GET, $page) ?>"><?php echo $page ?></a>
                    </li>
                    <?php endforeach; ?>
                    <li><a <?php if($_GET['p'] < $pageMax): ?>href="/course/search_video<?php echo copyAndSetPageURI($_GET, $_GET['p'] + 1) ?>"
